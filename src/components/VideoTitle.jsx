    ...
    <div className="absolute top-[32%] left-0 z-20 w-full px-6 sm:top-[36%] sm:px-8 md:top-[40%] md:px-10">
      <div className="w-[85%] sm:w-3/4 md:w-[45%] max-w-lg">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button className="flex items-center gap-1.5 rounded-lg bg-white px-4 py-2 text-xs font-semibold text-black transition hover:bg-white/80 sm:gap-2 sm:px-8 sm:text-sm md:px-10">
            <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 translate-x-[1px] fill-black sm:h-4 sm:w-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-gray-500/70 px-3 py-2 text-xs font-semibold text-white transition hover:bg-gray-500/90 sm:gap-2 sm:px-5 sm:text-sm"
          >
